...
export default function Menu() {
  ...
  return (
    <>
      ...
      <ul
        className=" hidden text-sm dark:bg-opacity-80 bg-opacity-80 font-light shadow-md absolute bg-zinc-100 dark:bg-black dark:md:bg-transparent dark:text-white p-4 top-full left-4 lg:basis-5/6 lg:shadow-none lg:bg-transparent lg:static lg:p-0 lg:flex lg:justify-between   lg:w-full lg:min-w-220"
        ref={menu}
        onMouseOver={openMenu}
        onMouseLeave={hiddenMenu}
      >
